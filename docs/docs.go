        ...
        "/user/change-password": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "UserUpdatePassRequest",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.UserUpdatePassRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/model.FollowResponse"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "model.FollowResponse": {
            ...
            "properties": {
                "followUserInfo": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.FollowUserInfoResponse"
                    }
                },
                "total": {
                    "type": "integer"
        ...
        "model.UserUpdateRequest": {
            ...
            "properties": {
                ...
                "location": {
                    "$ref": "#/definitions/model.LocationUpdateRequest"
                },
                "sex": {
                    "type": "boolean"
                },
